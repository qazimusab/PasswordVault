    ...
    public void onCancel(DialogInterface dialog) {
        ...
        for (int i = 0; i < items.size(); i++) {
            if (items.get(i).isSelected()) {
                spinnerBuffer.append(items.get(i).getPermission().getDepartmentName());
...
//				items = (ArrayList<KeyPairBoolData>) adapter.arrayList;
    ...
    public class MyAdapter extends BaseAdapter implements Filterable {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            holder.textView.setText(data.getPermission().getDepartmentName());
                ...
                public void onClick(View v)
                {
                    ...
                    for (int i = 0; i < len; i++)
                    {
                        if (i == position)
                        {
                            ...
                            Log.i("TAG", "On Click Selected : " + data.getPermission().getDepartmentName() + " : " + data.isSelected());
                            break;
                        }
                    }
                }
                ...
                protected FilterResults performFiltering(CharSequence constraint) {
                    ...
                    if (constraint == null || constraint.length() == 0) {
                        ...
                        for (int i = 0; i < mOriginalValues.size(); i++) {
                            Log.i("TAG", "Filter : " + mOriginalValues.get(i).getPermission().getDepartmentName() + " -> " + mOriginalValues.get(i).isSelected());
                            String data = mOriginalValues.get(i).getPermission().getDepartmentName();
